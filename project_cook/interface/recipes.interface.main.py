...
def preprocess(min_date:str = '2009-01-01', max_date:str = '2015-01-01') -> None:
    ...
    from project_cook.ml_logic.data import get_data_with_cache, clean_data, load_data_to_bq
    from project_cook.ml_logic.preprocessor import preprocess_features
...
def train(min_date:str = '2009-01-01',
    ...
    from project_cook.ml_logic.data import get_data_with_cache
    from project_cook.ml_logic.registry import load_model, save_model, save_results
    from project_cook.ml_logic.model import initialize_model, compile_model, train_model
    ...
    # Save results on hard drive using recipes.ml_logic.registry
...
def evaluate(min_date:str = '2014-01-01',
    ...
    from project_cook.ml_logic.data import get_data_with_cache
    from project_cook.ml_logic.model import evaluate_model
    from project_cook.ml_logic.registry import load_model, save_results
...
def pred(X_pred: pd.DataFrame = None) -> np.ndarray:
    ...
    from project_cook.ml_logic.registry import load_model
    from project_cook.ml_logic.preprocessor import preprocess_features
